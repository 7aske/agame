...
extern void enemy_search(entity_t* e, entity_t* tar, char const* level, int width, int height, int boundary, int force_search);

extern void enemy_randmove(entity_t* e, char const* lvl, int width, int bound);

extern void enemy_fpath(entity_t* e, char const* lvl, int width, int bound);
